...
<div id="mainContent" class="main-content">
    <div class="container-fluid px-4 py-4">
        ...
        <div class="d-flex gap-2 flex-wrap mb-3">
            <input type="text" id="search" class="form-control" placeholder="Cari peminjam atau alat..."
                style="width:220px">

            <select id="status_denda" class="form-select" style="width:160px">
                <option value="">Semua Status</option>
                <option value="belum">Belum Dibayar</option>
                <option value="lunas">Sudah Lunas</option>
            </select>

            <select id="direction" class="form-select" style="width:140px">
        ...
        <div class="card shadow-sm border-0">
            <div class="card-body" id="dendaTable">
                @include('petugas.denda.partials.table', [
...
function fetchDenda(page = 1) {
    ...
    fetch(`{{ route('petugas.denda.index') }}?${query}`, {
            headers: {
