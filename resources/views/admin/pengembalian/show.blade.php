...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h3 class="mb-1">Detail Pengembalian Buku</h3>
        <p class="text-muted mb-0">Informasi lengkap proses pengembalian buku</p>
    </div>
...
<div class="row g-4">
    ...
    <div class="col-12">
        <form id="formPengembalian" method="POST" action="{{ route('admin.pengembalian.store',$peminjaman->id) }}">
            @csrf
